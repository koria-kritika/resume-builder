...
export const enhanceProfessionalSummary = async (req, res) => {
  try {
    ...
    const prompt = `
Enhance the following professional summary to sound polished, concise,
and ATS-friendly. Keep it to 1–2 sentences.
...
export const enhanceJobDescription = async (req, res) => {
  try {
    ...
    const prompt = `
Enhance the following job description to be impactful,
ATS-friendly, and action-oriented.
